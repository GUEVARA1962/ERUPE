...
func (s *Session) makeSignInResp(uid int) []byte {
	...
	noticeText := "<BODY><CENTER><SIZE_3><C_4>Erupe SU9 Beta 2 へようこそ!<BR><BODY><LEFT><SIZE_2><C_5>Erupeは実験的なソフトウェアです。<C_7>インストールによる<BR><BODY>いかなる問題にも責任を負いかねます!<BR><BODY><BR><BODY><C_4>■バグの報告はDiscordで!<C_7><BR><BODY><BR><BODY><C_4>■全てテストしてください!<C_7><BR><BODY><BR><BODY><C_4>■バグをかかえているNPCに話しかけないでください!<C_7><BR><BODY><BR><BODY><C_4>■GitHubでコードをフォークしてください!<C_7><BR><BODY><BR><BODY>貢献してくださった方々に感謝します。<BR><BODY><BR><BODY>これはあなた達なしでは完成しなかったでしょう。"
